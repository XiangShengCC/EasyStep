            ...
            <div class="accordion-item" v-for="vender in venders" :key="vender.venderId">
                ...
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        :data-bs-target="target(vender.venderId)" aria-expanded="false"
                        :aria-controls="getIdStr(vender.venderId)">
                        <strong>
                ...
                <div class="container collapse" :id="getIdStr(vender.venderId)">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <button type="button" v-if="vender.enable == true || vender.enable == 'true'"
                            class="btn btn-outline-warning buttonSelected" @click.prevent="suspend(vender.venderId)">
                            帳號停權
                        </button>
                        <button type="button" v-else class="btn btn-outline-warning buttonSelected"
                            @click.prevent="restore(vender.venderId)">
                            帳號復權
                        </button>
                    </div>
