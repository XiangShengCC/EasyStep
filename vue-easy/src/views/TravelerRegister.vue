        ...
        <div class="row g-3 needs-validation">
          ...
          <div class="col-md-6 position-relative ">
            ...
            <div class="input-group">
              <input required :type="yespassword ? 'text' : 'password'" class="form-control" id="pwd" v-model="pwd"
          ...
          <div class="col-md-6 position-relative mb-3">
            ...
            <div class="input-group">
              <input required :type="yespassword2 ? 'text' : 'password'" class="form-control" id="repwd" v-model="repwd"
                placeholder="6-15位中英字">
              <span class="input-group-text">
