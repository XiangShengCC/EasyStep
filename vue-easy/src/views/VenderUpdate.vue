            ...
            <div class="row g-3 needs-validation " novalidate>
              <div class="col-md-4 position-relative">
                ...
                <div class="input-group">
                  <input :type="yespassword ? 'text' : 'password'" class="form-control" id="pwd" v-model="pwd"
                    placeholder="6-15位中英字">
                  <span class="input-group-text">
                    <i class="bi bi-eye-slash" @click="showPassword" :hidden="closeIsHidden"></i>
                    <i class="bi bi-eye" @click="closePassword" :hidden="ShowIsHidden"></i>
                  </span>
                </div>
              </div>
              <div class="col-md-4 position-relative">
                ...
                <div class="input-group">
                  <input :type="yespassword2 ? 'text' : 'password'" class="form-control" id="newPwd" v-model="newPwd"
                    placeholder="6-15位中英字" oninput="chkPwd()">
                  <span class="input-group-text">
                    <i class="bi bi-eye-slash" @click="showPassword2" :hidden="closeIsHidden2"></i>
                    <i class="bi bi-eye" @click="closePassword2" :hidden="ShowIsHidden2"></i>
                  </span>
                </div>
              </div>
              <div class="col-md-4 position-relative">
                ...
                <div class="input-group">
                  <input :type="yespassword3 ? 'text' : 'password'" class="form-control" id="reNewPwd" v-model="reNewPwd"
                    placeholder="6-15位中英字" oninput="chkPwdChk()">
                  <span class="input-group-text">
                    <i class="bi bi-eye-slash" @click="showPassword3" :hidden="closeIsHidden3"></i>
                    <i class="bi bi-eye" @click="closePassword3" :hidden="ShowIsHidden3"></i>
                  </span>
                </div>
              </div>
              <div class="d-grid gap-2 col-8 mx-auto mt-5">
...
//設定密碼
const closeIsHidden = ref(false);
const ShowIsHidden = ref(true);
const yespassword = ref(false);

const closeIsHidden2 = ref(false);
const ShowIsHidden2 = ref(true);
const yespassword2 = ref(false);

const closeIsHidden3 = ref(false);
const ShowIsHidden3 = ref(true);
const yespassword3 = ref(false);

//顯示密碼
const showPassword = () => {
  ShowIsHidden.value = false;
  closeIsHidden.value = true;
  yespassword.value = true;
}
const showPassword2 = () => {
  ShowIsHidden2.value = false;
  closeIsHidden2.value = true;
  yespassword2.value = true;
}
const showPassword3 = () => {
  ShowIsHidden3.value = false;
  closeIsHidden3.value = true;
  yespassword3.value = true;
}
//關閉密碼
const closePassword = () => {
  ShowIsHidden.value = true;
  closeIsHidden.value = false;
  yespassword.value = false;
}
const closePassword2 = () => {
  ShowIsHidden2.value = true;
  closeIsHidden2.value = false;
  yespassword2.value = false;
}
const closePassword3 = () => {
  ShowIsHidden3.value = true;
  closeIsHidden3.value = false;
  yespassword3.value = false;
}
