<template>
    <div class="container">
        ...
        <div class="accordion" id="accordionExample"
            v-if="this.adminLoginStatus == true || this.adminLoginStatus == 'true'">
            <div class="accordion-item" v-for="traveler in travelers" :key="traveler.travelerId">

                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        :data-bs-target="target(traveler.travelerId)" aria-expanded="false"
                        :aria-controls="getIdStr(traveler.travelerId)">
                        <strong>
                ...
                <div class="container collapse" :id="getIdStr(traveler.travelerId)">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <button type="button" v-if="traveler.enable == true || traveler.enable == 'true'"
                            class="btn btn-outline-warning buttonSelected" @click.prevent="suspend(traveler.travelerId)">
                            帳號停權
                        </button>
                        <button type="button" v-else class="btn btn-outline-warning buttonSelected"
                            @click.prevent="restore(traveler.travelerId)">
                            帳號復權
                        </button>
                    </div>
