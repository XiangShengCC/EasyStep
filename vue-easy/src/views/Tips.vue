<template>
    <div class="container">
        ...
        <div v-if="this.adminLoginStatus == true || this.adminLoginStatus == 'true'" class="contenter" role="group"
            aria-label="Basic example">
            <button type="button" class="btn btn-outline-primary" data-bs-toggle="collapse" data-bs-target="#addTip"
                aria-expanded="false" aria-controls="addTip">
                新增旅行訣竅&nbsp;&nbsp;&nbsp;+
            </button>
            ...
            <div class="accordion-item" v-for="tip in this.tips" :key="tip.tipId">
                ...
                <h2 class="accordion-header">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse"
                        :data-bs-target="target(tip.tipId)" aria-expanded="false" :aria-controls="getIdStr(tip.tipId)">
                ...
                <div :id="getIdStr(tip.tipId)" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    ...
                    <div v-if="this.adminLoginStatus == true || this.adminLoginStatus == 'true'" class="contenter"
                        role="group" aria-label="Basic example">
                        <span>&nbsp;&nbsp;</span>

                        <button type="button" class="btn btn-outline-danger"
                            @click.prevent="deleteTip(tip.tipId)">刪除</button>

                        <span>&nbsp;&nbsp;</span>

                        <button type="button" class="btn btn-outline-warning buttonSelected" data-bs-toggle="collapse"
                            :data-bs-target="targetEdit(tip.tipId)" aria-expanded="false"
                            :aria-controls="getEditId(tip.tipId)">
                            編輯
                        </button>
                        ...
                        <div class="container collapse" :id="getEditId(tip.tipId)">
                            ...
                            <form>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" :id="getEditTitle(tip.tipId)"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" :id="getEditTitle(tip.tipId)"
                                        v-model="this.edit.details">
                                </div>

                                <button type="reset" class="btn btn-outline-danger" @click="clearEdit">清除</button>
                                <span>&nbsp; &nbsp;</span>
                                <button type="submit" class="btn btn-outline-success"
                                    @click.prevent="editTip(tip.tipId, tip.title, tip.details)">更新</button>
                            </form>
...
export default {
    ...
    methods: {
        ...
        submitData() {
            this.new.title = 'Tip 8.提前規劃交通方法'
            this.new.details = '搭乘公共交通工具或者自駕都是一個好方法喔，也可以提前詢問老闆是否有接送方法。'
        }
    }
}
</script>
