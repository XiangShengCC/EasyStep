        ...
        <div class="row g-3 needs-validation">
          ...
          <div class="col-md-6 position-relative">
            ...
            <div class="input-group">
              <input required :type="yespassword ? 'text' : 'password'" class="form-control" id="pwd" name="pwd"
                v-model="pwd" placeholder="6-15位中英字" oninput="chkPwd()">
          ...
          <div class="col-md-6 position-relative mb-3">
            ...
            <div class="input-group">
              <input required :type="yespassword2 ? 'text' : 'password'" class="form-control" id="repwd" name="repwd"
                v-model="repwd" placeholder="6-15位中英字" oninput="chkPwdChk()">
              <span class="input-group-text">
