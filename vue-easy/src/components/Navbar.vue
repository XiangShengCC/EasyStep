					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item dropdown"
								v-if="logoutVisible || (adminLoginStatus == true || adminLoginStatus == 'true')">
								<!-- 超級管理員用 -->
								<a v-if="adminLoginStatus == true || adminLoginStatus == 'true'"
							...
							<li class="nav-item dropdown ml-auto"
								v-if="logVisible && !(adminLoginStatus == true || adminLoginStatus == 'true')">
								<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
									aria-expanded="false">
									登入
								</a>
							...
							<li class="nav-item ml-auto">
								<!-- 超級管理員用 -->
								<button v-if="adminLoginStatus == true || adminLoginStatus == 'true'" class="btn btn-light"
									@click="adminLogout">
									管理者登出
								</button>
...
function chkAdminLogin() {
	// console.log(`chkAdminLogin() execute !!`)
	if (sessionStorage.getItem('adminLoginStatus') != null) {
		adminLoginStatus.value = sessionStorage.getItem('adminLoginStatus')
	}
	// console.log(`adminLoginStatus = ${typeof adminLoginStatus.value} ${adminLoginStatus.value}`)
